                        ...
                        <form method="post" action="Controlador?menu=Ventas">
                            <div class="row">
                                <div class="col-md-4 d-flex">
                                    <input type="number" name="documentocliente" value="${cliente.getDocumento()}" style="width: 125px;" class="form-control mr-1" placeholder="documento cliente">
                                    <input type="submit" name="accion" value="BuscarCliente" class="btn btn-outline-dark">
                                </div>
                                <div class="col-md-8 d-flex">
                                    <input type="text" name="nombrecliente" value="${cliente.getNombre()}" class="form-control ml-2" placeholder="Nombre cliente">
                                </div>
                            </div>
                            <div class="row"></div>
                        ...
                        <form action="Controlador?menu=Ventas" method="post">
                            <div class="row">
                                <div class="col-md-4 d-flex form-group">
                                    <input type="number" name="codigoproducto" style="width: 95px;" class="form-control mr-1" placeholder="Codigo Producto" value="${productoseleccionado.getCodigo()}">
                        ...
                        <table class="table">
                            ...
                            <c:forEach var="lista" items="${listaventas}">
                                <tr>
                                    ...
                                    <td style="width: 30px;">$ ${lista.getPrecio()}</td>
                                    <td style="width: 20px;">${lista.getCantidad()}</td>
